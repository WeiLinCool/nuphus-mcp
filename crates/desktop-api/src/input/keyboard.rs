//! Keyboard control — native Win32 / enigo on macOS / PlatformNotSupported on Linux
...
pub async fn hotkey(keys: &[&str]) -> Result<()> {
    let vks: Vec<u16> = keys.iter().map(|k| key_to_vk(k)).collect::<Result<Vec<_>>>()?;
    #[cfg(windows)]
    {
        use ::windows::Win32::UI::Input::KeyboardAndMouse::{
            keybd_event, KEYEVENTF_KEYUP,
...
fn key_to_vk(key: &str) -> Result<u16> {
    match key.to_lowercase().as_str() {
        "enter" | "return" => Ok(0x0D), "tab" => Ok(0x09),
        "esc" | "escape" => Ok(0x1B), "space" => Ok(0x20),
        "backspace" => Ok(0x08), "delete" | "del" => Ok(0x2E),
        "up" => Ok(0x26), "down" => Ok(0x28), "left" => Ok(0x25), "right" => Ok(0x27),
        "home" => Ok(0x24), "end" => Ok(0x23), "pageup" => Ok(0x21), "pagedown" => Ok(0x22),
        "ctrl" | "control" => Ok(0x11), "shift" => Ok(0x10), "alt" => Ok(0x12),
        ...
        "a" => Ok(0x41), "b" => Ok(0x42), "c" => Ok(0x43), "d" => Ok(0x44),
        "e" => Ok(0x45), "f" => Ok(0x46), "g" => Ok(0x47), "h" => Ok(0x48),
        "i" => Ok(0x49), "j" => Ok(0x4A), "k" => Ok(0x4B), "l" => Ok(0x4C),
        "m" => Ok(0x4D), "n" => Ok(0x4E), "o" => Ok(0x4F), "p" => Ok(0x50),
        "q" => Ok(0x51), "r" => Ok(0x52), "s" => Ok(0x53), "t" => Ok(0x54),
        "u" => Ok(0x55), "v" => Ok(0x56), "w" => Ok(0x57), "x" => Ok(0x58),
        "y" => Ok(0x59), "z" => Ok(0x5A),
        "0" => Ok(0x30), "1" => Ok(0x31), "2" => Ok(0x32), "3" => Ok(0x33),
        "4" => Ok(0x34), "5" => Ok(0x35), "6" => Ok(0x36), "7" => Ok(0x37),
        "8" => Ok(0x38), "9" => Ok(0x39),
...
fn vk_to_enigo(vk: u16) -> Result<enigo::Key> {
    ...
    Ok(match vk {
        ...
        0x11 => Control, 0x10 => Shift, 0x12 => Alt, 0x5B => Meta,
